...
add_walk_trips <- function(pt_trips){
  ...
  pt_trips$trip_distance_cat[pt_trips$trip_distance > 0 &
                               pt_trips$trip_distance < DIST_LOWER_BOUNDS[2]] <- DIST_CAT[1]
  pt_trips$trip_distance_cat[pt_trips$trip_distance >= DIST_LOWER_BOUNDS[2] &
                               pt_trips$trip_distance < DIST_LOWER_BOUNDS[3]] <- DIST_CAT[2]
  pt_trips$trip_distance_cat[pt_trips$trip_distance >= DIST_LOWER_BOUNDS[3]] <- DIST_CAT[3]

  walk_trips$trip_distance_cat[walk_trips$trip_distance > 0 &
                                 walk_trips$trip_distance < DIST_LOWER_BOUNDS[2]] <- DIST_CAT[1]
  walk_trips$trip_distance_cat[walk_trips$trip_distance >= DIST_LOWER_BOUNDS[2] &
                                 walk_trips$trip_distance < DIST_LOWER_BOUNDS[3]] <- DIST_CAT[2]
